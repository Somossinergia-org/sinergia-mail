...
export default function MobileChatFab({ onClick }: Props) {
  return (
    <button
      onClick={onClick}
      className="lg:hidden fixed z-30 right-4 bottom-[148px] w-10 h-10 rounded-full flex items-center justify-center bg-gradient-to-br from-purple-500/90 to-fuchsia-600/90 text-white border border-purple-400/40 active:scale-90 transition-transform"
      style={{
